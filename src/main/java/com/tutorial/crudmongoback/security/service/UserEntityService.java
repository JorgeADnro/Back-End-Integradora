...
public class UserEntityService {
	...
	public JwtTokenDto login(LoginUserDto dto) {
        Authentication authentication =
                authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(dto.getUsername(), dto.getPasswd()));
	...
	private UserEntity mapUserFromDto(CreateUserDto dto) {
		...
		String password = passwordEncoder.encode(dto.getPasswd());
		List<RoleEnum> roles =
